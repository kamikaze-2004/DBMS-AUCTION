...
import { faHome, faUser, faInfoCircle, faHandHoldingUsd, faEnvelope,faCar } from "@fortawesome/free-solid-svg-icons";
import carseekImg from "./carseek.jpg";

export default function Header({ user, isLandingpageOpen, setIsLandingpageOpen }) {
